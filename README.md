...
## Algorithm
1. Load the weather dataset and preprocess it by handling missing values using interpolation and sorting by time.

2. Extract time-based features (hour, sine, cosine) and create lag features for target variables.

3. Select relevant input features and split the dataset into training (80%) and testing (20%) sets.

4. Train a Random Forest Regressor separately for each target (temperature, PM2.5, energy) and generate predictions.

5. Evaluate model performance using R² and MAE, visualize results, and predict future values using latest data.
...
## Output:
<img width="1028" height="387" alt="image" src="https://github.com/user-attachments/assets/c0f9c301-61d7-4017-b51a-3ecb22fbc148" />
<img width="1027" height="387" alt="image" src="https://github.com/user-attachments/assets/0ada41d4-9773-4f74-85f8-4eb0567a4c43" />
<img width="1019" height="380" alt="image" src="https://github.com/user-attachments/assets/d013c230-6718-437a-af6b-179184ac4e4d" />
